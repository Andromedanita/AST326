...
Table [...] shows these values along with their errors.
...
Error          &   6.156 $10^{-5}$        &       1.097  $10^{-3}$    &     4.938 $10^{-2}$       \\[1ex] % [1ex] adds vertical space
\hline %inserts single line
\end{tabular}
\label{table:nonlin} % is used to refer this table in the text
\end{table}
...
Error          &              &              &   -   & 0.0432 &  0.0480  \\  \hline
Calculated(Fourier Method) &   0.408  & 0.0064  & 522.7807  & 1.839 &2.044 \\ \hline
Error          &              &              &   -   & 0.0432 &  0.0480  \\[1ex]
\hline %inserts single line
\end{tabular}
\label{table:nonlin} % is used to refer this table in the text
\end{table}
...
Calculated(Fourier) &  0.5256   &  25.38 & 335.0652  & -7.09 & 713424.68 &155547492.76\\ \hline
Error          &   0.0007  &   -        &     -            &   -      & 16767.97      &   3655909.1 \\[1ex]
\hline %inserts single line
\end{tabular}
\label{table:nonlin} % is used to refer this table in the text
\end{table}
