...
We need the values of true and eccentric anomalies at different times, so we must iteratively solve for E using Newton?s method given in equation (..E=. 21), where we used \begin{math} E_{0}=M
